...
import EnterPriseImage from '@assets/svg/enterprise.svg'
        ...
        <section id='#enterprise' className='my-20'>
            <Container>
                <div>
                    ...
                    <div className='mt-8 px-5 lg:px-32 py-20 bg-brand-green-500 rounded-3xl shadow-2xl justify-between items-start border-2 border-brand-green-500 flex flex-col lg:flex-row'>
                        <div className='flex w-full lg:w-1/2'>
                            <Image src={EnterPriseImage} alt='Eatlater enterprise' className=' w-[300px] lg:w-[400px]' />
                        </div>
                        <div className='text-white  w-full lg:w-1/2'>
                            <h1 className='font-medium text-xl md:text-3xl mb-4 w-9/12'>Enroll your employees on Eatlater Enterprise</h1>
                            <p className='leading-8 font-light text-base md:text-lg'>
